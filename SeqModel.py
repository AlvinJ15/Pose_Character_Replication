...
class UpConv(nn.Module):
    def __init__(
        ...
        #self.conv = lu.Conv2dReLU(in_channels, out_channels, kernel_size, padding)
...
class UNetLSTM(nn.Module):
    def __init__(self, params_model):
        ...
        self.upConv5c = nn.Conv2d(32,1, kernel_size=1,padding=0)#output
    ...
    def forward(self, x):
        ...
        #xLSTM = secuenceInput.view(secuenceInput.shape[0],secuenceInput.shape[1],-1)
        #lstmout,_ = self.centerLSTM(xLSTM)
        #xLSTM = lstmout[:,-1]
        #xLSTM = xLSTM.view(xLSTM, secuenceInput.shape[0], 512, self.input_dim/32, self.input_dim/32)
